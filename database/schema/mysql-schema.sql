...
CREATE TABLE `articles` (
  ...
  KEY `articles_type_status_index` (`type`,`status`),
...
CREATE TABLE `banners` (
  ...
  `position` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'home_slider',
  `order` int NOT NULL DEFAULT '0',
...
CREATE TABLE `product_attribute_values` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `product_attribute_values_product_id_attribute_value_id_unique` (`product_id`,`attribute_value_id`),
...
CREATE TABLE `redirects` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `redirects_old_url_index` (`old_url`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `seo_pages` (
  ...
  `custom_body` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `seo_pages_page_type_unique` (`page_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (1,'2026_02_10_061241_create_menus_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (2,'0001_01_01_000000_create_users_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (3,'0001_01_01_000001_create_cache_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'0001_01_01_000002_create_jobs_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2026_01_30_034732_create_media_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2026_01_30_034735_create_permission_tables',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2026_01_30_034800_create_cms_tables',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2026_01_30_034900_create_system_tables',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2026_02_10_025230_create_tenants_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2026_02_10_032407_add_extra_fields_to_users_table',2);
