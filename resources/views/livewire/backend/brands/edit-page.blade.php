<div class="space-y-8 pb-32">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-text-main tracking-tight uppercase tracking-[0.1em]">Sửa thương hiệu</h1>
                <p class="text-[11px] font-black text-text-muted mt-1 uppercase tracking-widest opacity-60">Cập nhật thông tin nhận diện cho thương hiệu.</p>
            </div>
        </div>
    ...
    <form wire:submit="save" class="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
        ...
        <div class="xl:col-span-8 space-y-8">
            <x-admin.form-section title="Thông tin cơ bản" icon="ti-info-circle" color="blue">
                <div class="space-y-6">
                    ...
                    <x-backend.forms.textarea wire:model="description" name="description" label="Mô tả thương hiệu" rows="5" placeholder="Mô tả về lịch sử, sứ mệnh hoặc đặc điểm thương hiệu..." />
                </div>
        ...
        <div class="xl:col-span-4 space-y-8 xl:sticky xl:top-24">
            ...
            <x-admin.form-section title="Logo thương hiệu" icon="ti-photo" color="purple">
                <x-backend.forms.media-uploader 
                    wire:model="logo"
                    :model="$logo"
                    :currentImages="$currentLogoUrl ? [['url' => $currentLogoUrl]] : []"
                    label=""
        ...
        <x-admin.sticky-bar
            ...
            target="save, logo"
            saveLabel="Cập nhật thương hiệu"
            mode="Edit"
        >
            <x-slot:info>
