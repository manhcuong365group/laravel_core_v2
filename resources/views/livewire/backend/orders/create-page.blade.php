<div class="space-y-8 pb-32">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-text-main tracking-tight uppercase tracking-[0.1em]">Tạo đơn hàng</h1>
                <p class="text-[11px] font-black text-text-muted mt-1 uppercase tracking-widest opacity-60">Khởi tạo đơn hàng mới cho khách hàng.</p>
            </div>
        </div>
    ...
    <form wire:submit="save" class="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
        ...
        <x-admin.sticky-bar
            ...
            target="save"
            saveLabel="Tạo đơn hàng ngay"
            mode="New Order"
        >
            <x-slot:info>
                <span class="text-[13px] font-bold text-text-main">Khách: {{ $customer_name || 'Khách mới...' }}</span>
            </x-slot:info>
        </x-admin.sticky-bar>
    </form>
</div>
