<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-black text-text-main tracking-tight">Sửa người dùng: {{ $user->name }}</h1>
            <p class="text-sm text-text-muted mt-1">Cập nhật thông tin tài khoản và phân quyền.</p>
        </div>
    </div>
                ...
                <x-backend.layout.card title="Ảnh đại diện" class="p-6">
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div class="text-center">
                            ...
                            @error('avatar') <span class="text-xs text-danger">{{ $message }}</span> @enderror
                        </div>
                    </div>
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <x-backend.ui.button type="submit" variant="primary" icon="ti ti-check" wire:loading.attr="disabled">
                        <span wire:loading.remove>Cập nhật người dùng</span>
