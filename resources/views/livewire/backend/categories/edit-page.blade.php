<div class="space-y-6 pb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            <div class="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20 shadow-inner text-primary">
                 <i class="ti ti-edit-circle text-2xl animate-pulse"></i>
            </div>
            <div>
                <h1 class="text-2xl font-black text-text-main tracking-tight">{{ $pageTitle }}</h1>
                <p class="text-sm text-text-muted mt-1 leading-relaxed">Chỉnh sửa thông tin và cấu hình cho danh mục của bạn.</p>
            </div>
        </div>
        <div class="flex items-center gap-3">
             <x-backend.ui.button variant="neutral" :href="route('backend.categories.index', $type)" icon="ti ti-arrow-left" class="bg-bg-surface hover:bg-bg-body font-bold">
                Quay lại
            </x-backend.ui.button>
        </div>
    </div>
        ...
        @if ($errors->any())
            <div class="lg:col-span-12 p-4 mb-4 bg-danger/10 border border-danger/20 rounded-2xl animate-shake">
                <div class="flex items-center gap-3 text-danger">
                    ...
                    <div>
                        <p class="font-bold text-sm">Có lỗi xảy ra khi cập nhật danh mục!</p>
        ...
        <div class="lg:col-span-8 space-y-8">
            ...
            <x-backend.layout.card variant="glass" class="p-8 group/card glow-on-hover overflow-visible">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 text-text-main">
        ...
        <div class="lg:col-span-4 space-y-8 lg:sticky lg:top-24 self-start">
            ...
            <x-backend.layout.card variant="glass" class="p-8 group/card overflow-visible">
                 <div class="flex items-center gap-3 mb-8 border-b border-border-glass pb-6">
                    <div class="w-8 h-8 rounded-lg bg-accent/20 flex items-center justify-center text-accent">
                        <i class="ti ti-settings-automation text-lg"></i>
                    </div>
                    ...
                    <div class="p-4 bg-bg-body/30 rounded-2xl border border-border-glass/50 space-y-4">
                        ...
                        <label class="flex items-center justify-between cursor-pointer group">
                             ...
                             <div class="relative">
                                ...
                                <div class="w-11 h-6 bg-border-glass peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-border-glass after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-info border-none shadow-inner transition-colors"></div>
                             </div>
                        </label>
                    </div>
                </div>
            ...
            <x-backend.layout.card variant="glass" class="p-8 group/card overflow-visible">
                 <div class="flex items-center gap-3 mb-8 border-b border-border-glass pb-6">
                    <div class="w-8 h-8 rounded-lg bg-info/20 flex items-center justify-center text-info">
                        <i class="ti ti-photo-circle text-lg"></i>
                    </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                >
                    ...
                    <span wire:loading.remove class="uppercase tracking-widest font-black text-sm">Cập nhật danh mục</span>
                    <span wire:loading class="uppercase tracking-widest font-black text-sm">Đang lưu...</span>
                </x-backend.ui.button>
                <x-backend.ui.button 
                    variant="neutral" 
                    :href="route('backend.categories.index', $type)" 
                    class="w-full py-3 opacity-80 hover:opacity-100 transition-opacity font-bold"
                >
                    Hủy bỏ
                </x-backend.ui.button>
            </div>
