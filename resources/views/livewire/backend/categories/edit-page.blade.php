    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-[11px] font-black text-text-muted mt-1 uppercase tracking-widest opacity-60">Chỉnh sửa thông tin và cấu hình cho danh mục.</p>
            </div>
        </div>
            ...
            <x-admin.form-section title="Hình ảnh đại diện" icon="ti-photo" color="purple">
                <div class="space-y-4">
                    <x-backend.forms.media-uploader 
                        wire:model="image"
                        :model="$image"
                        :currentImages="$currentImageUrl ? [['url' => $currentImageUrl]] : []"
                        label=""
