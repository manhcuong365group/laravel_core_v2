...
class UrlPolicy
{
    ...
    {
        return $user->hasPermissionTo('urls.view');
    }
    ...
    {
        return $user->hasPermissionTo('urls.create');
    }
    ...
    {
        return $user->hasPermissionTo('urls.edit');
    }
    ...
    {
        return $user->hasPermissionTo('urls.delete');
    }
